...
export const zhTWAiMessages: Messages = {
  ...
  'ai.externalMcp.usage.keepRunning': '1. 開啟下方開關，並保持 Netcatty 執行。',
  ...
  'ai.externalMcp.clientConfiguration.description': '可一鍵設定 Codex / Claude Code / Grok，或複製 Cursor MCP 片段。',
