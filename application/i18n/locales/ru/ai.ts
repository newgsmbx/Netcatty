...
export const ruAiMessages: Messages = {
  ...
  'ai.externalMcp.usage.keepRunning': '1. Включите переключатель и держите Netcatty запущенным.',
  ...
  'ai.externalMcp.clientConfiguration.description': 'Однокнопочная настройка Codex / Claude Code / Grok или фрагмент для Cursor.',
