...
export const ruCoreMessages: Messages = {
  ...
  'settings.terminal.connection.sshTcpConnectTimeout': 'Тайм-аут TCP-подключения SSH',
  'settings.terminal.connection.sshTcpConnectTimeout.desc': 'Время ожидания установки сетевого соединения в секундах (1–3600).',
  'settings.terminal.connection.sshAuthReadyTimeout': 'Тайм-аут аутентификации SSH',
  'settings.terminal.connection.sshAuthReadyTimeout.desc': 'Время ожидания завершения рукопожатия и аутентификации SSH в секундах (1–3600).',
