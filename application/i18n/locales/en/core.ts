...
export const enCoreMessages: Messages = {
  ...
  'settings.terminal.connection.sshTcpConnectTimeout': 'SSH TCP connection timeout',
  'settings.terminal.connection.sshTcpConnectTimeout.desc': 'Seconds to wait for the network connection to be established (1–3600).',
  'settings.terminal.connection.sshAuthReadyTimeout': 'SSH authentication timeout',
  'settings.terminal.connection.sshAuthReadyTimeout.desc': 'Seconds to wait for the SSH handshake and authentication to finish (1–3600).',
