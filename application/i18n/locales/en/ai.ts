...
export const enAiMessages: Messages = {
  ...
  'ai.externalMcp.usage.keepRunning': '1. Enable the switch below and keep Netcatty running.',
  ...
  'ai.externalMcp.clientConfiguration.description': 'One-click setup for Codex / Claude Code / Grok, or copy a Cursor MCP snippet.',
