...
export const zhCNAiMessages: Messages = {
  ...
  'ai.externalMcp.usage.keepRunning': '1. 打开下方开关，并保持 Netcatty 运行。',
  ...
  'ai.externalMcp.clientConfiguration.description': '可一键配置 Codex / Claude Code / Grok，或复制 Cursor MCP 片段。',
  ...
  'ai.externalMcp.cursor.description': '粘贴到 MCP 配置文件（例如 ~/.cursor/mcp.json）。',
