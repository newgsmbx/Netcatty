...
export const zhCNTerminalMessages: Messages = {
  ...
  'terminal.toolbar.showActions': '显示终端操作',
  ...
  'settings.terminal.connection.sshTcpConnectTimeout': 'SSH TCP 连接超时',
  'settings.terminal.connection.sshTcpConnectTimeout.desc': '等待网络连接建立的秒数（1–3600）。',
  'settings.terminal.connection.sshAuthReadyTimeout': 'SSH 认证超时',
  'settings.terminal.connection.sshAuthReadyTimeout.desc': '等待 SSH 握手和认证完成的秒数（1–3600）。',
